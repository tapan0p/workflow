...
/* Custom styles for flat palette with no categories */
...
/* Hide any remaining category containers */
#red-ui-palette .red-ui-palette-category {
    display: none !important;
    border: none !important;
