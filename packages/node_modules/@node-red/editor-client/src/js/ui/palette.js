RED.palette = (function() {
    ...
    function init() {
        ...
        try {
            paletteState = JSON.parse(RED.settings.getLocal("palette-state") || '{"collapsed": []}');
        } catch (error) {
    ...
    function savePaletteState() {
        try {
            RED.settings.setLocal("palette-state", JSON.stringify({ collapsed: paletteState.collapsed }));
        } catch (error) {
