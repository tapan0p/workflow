...
RED.workspaces = (function() {
    ...
    function init() {
        ...
        // Create draggable triplets node in footer
        var footerContainer = $('<div style="width: 100%; text-align: center;"></div>')
            .appendTo("#red-ui-workspace-footer");
        
        // Create a node representation similar to palette nodes
        var tripletsNode = $('<div class="red-ui-palette-node"></div>')
            .attr("data-palette-type", "triplets")
            .css({
                "display": "inline-block",
                "backgroundColor": "#a6bbcf",  // This should match the color in triplets.html
                "margin": "6px",
                "position": "relative",
                "height": "28px",
                "width": "82px",
        ...
        $('<div class="red-ui-palette-label"></div>')
            .text("triplets")
            .appendTo(tripletsNode);
        
        // Add input/output ports like in the palette
        $('<div class="red-ui-palette-port red-ui-palette-port-input"></div>').appendTo(tripletsNode);
        $('<div class="red-ui-palette-port red-ui-palette-port-output"></div>').appendTo(tripletsNode);
        
        // Make it draggable
        $(tripletsNode).draggable({
            helper: 'clone',
        ...
        // Add tooltip
        RED.popover.tooltip(tripletsNode, "Drag to add triplets node");
