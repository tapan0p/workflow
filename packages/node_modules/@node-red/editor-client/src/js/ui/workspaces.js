...
RED.workspaces = (function() {
    ...
    function init() {
        // Create a wrapper for tabs + unit node
        $('<div id="red-ui-workspace-tabs-wrapper" style="display: flex; align-items: center; position: relative; width: 100%;"></div>').appendTo("#red-ui-workspace");
        $('<ul id="red-ui-workspace-tabs" style="flex: 1;"></ul>').appendTo("#red-ui-workspace-tabs-wrapper");
        
        // Add a container for the unit-node on the right side
        var unitNodeContainer = $('<div style="margin-right: 10px; margin-left: auto;"></div>').appendTo("#red-ui-workspace-tabs-wrapper");
        ...
        $('<div id="red-ui-workspace-toolbar" style="height: 40px; min-height: 40px; display: flex; align-items: center;"></div>').appendTo("#red-ui-workspace");
        $('<div id="red-ui-workspace-footer" class="red-ui-component-footer" style="height: 40px; line-height: 40px;"></div>').appendTo("#red-ui-workspace");
        $('<div id="red-ui-editor-shade" class="hide"></div>').appendTo("#red-ui-workspace");

        // Create draggable unit node to the right of tabs
        var unitNode = $('<div class="red-ui-palette-node"></div>')
            .attr("data-palette-type", "unit-node")
            .css({
                "display": "inline-block",
                "backgroundColor": "#a6bbcf",  // This should match the color in unit-node.html
                "margin": "2px 0",
                "position": "relative",
                "height": "28px",
                "width": "100px",
        ...
        // Add input/output ports like in the palette
        ...
        // Add tooltip
        RED.popover.tooltip(unitNode, "Drag to add unit node");
