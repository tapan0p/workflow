RED.contextMenu = (function () {
    ...
    function showConnectionDialog(link, condition) {
        ...
        // --- Content Panes ---
        var promptContentPane = $('<div id="red-ui-connection-dialog-pane-prompt" class="red-ui-connection-dialog-pane" "></div>').appendTo(dialogContent);
        var logicalContentPane = $('<div id="red-ui-connection-dialog-pane-logical" class="red-ui-connection-dialog-pane"style="display: none;"></div>').appendTo(dialogContent);
        ...
        // --- Save Function (Modified for selects) ---
            ...
            $('#prompt-conditions-list .prompt-condition-row').each(function() {
                ...
                var promptText = promptInput.data('full-prompt')?.trim();
