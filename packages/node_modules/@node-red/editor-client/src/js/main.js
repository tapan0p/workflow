$(function() {
    ...
    function callSchemaApi() {
        console.log("Calling schema API endpoint...");
        
        // Add a timestamp to prevent caching
        var apiUrl = "/api/load_schema?t=" + new Date().getTime();
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log("schema API call successful:", data);
                
                // Store the data for later use if needed
                window.schemaData = data;
                
                // Dispatch an event that other components can listen for
                $(document).trigger('schema-data-loaded', [data]);
            },
