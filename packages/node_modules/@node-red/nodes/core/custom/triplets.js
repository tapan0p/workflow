module.exports = function(RED) {
    ...
    function Triplets(config) {
        ...
        // Subscribe to function updates from frontend
        var functionUpdateHandler = function(topic, data) {
            node.log("Received function update from frontend");
        };

        // Subscribe to the WebSocket topic
        RED.comms.subscribe("triplets_functions_update", functionUpdateHandler);

        // Clean up subscription when node is removed
        this.on('close', function(done) {
            RED.comms.unsubscribe("triplets_functions_update", functionUpdateHandler);
            done();
        });
    }
